...
![withoutNA](c/users/jenny/Desktop/Coursera/RR/withoutNA.png)
...
par(mfrow=c(2,1))
plot(data.weekend, type="l", main="weekend", col="lightblue")
plot(data.weekday, type="l", main="weekday", col="lightblue")
```
